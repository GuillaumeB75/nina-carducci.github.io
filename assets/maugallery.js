  ...
  $.fn.mauGallery.methods = {
    ...
    showItemTags(gallery, position, tags) {
      ...
      $.each(tags, function(index, value) {
        tagItems += `<li class="nav-item"> <span class="nav-link"  data-images-toggle="${value}">${value}</span></li>`; // correction avec suppression "d'active" de "nav-item"
      });
    ...
    filterByTag() {
      ...
      $(this).addClass("active active-tag");  // correction ajout "active" à "active-tag"
